...
<b>Prompt:</b> As an external cyber security consultant, how would you design a cyber security audit program for Oscorp using the three lines of defence model?
...
c.	IAM Manager
d.	GRC Specialist
This team will be responsible to itself to perform regular audits to stay in compliance with business policies and framework specifications.
...
2)	Internal Compliance Auditor – To review the work of the operational team and the conclusions found by the Risk & Compliance Manager. Reports findings to business stakeholders and upper management.
