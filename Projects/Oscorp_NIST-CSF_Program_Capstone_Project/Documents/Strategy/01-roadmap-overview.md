...
2.  Define governance and risk processes.
3.  Understand assets, users, data and dependencies.
4.  Implement foundational controls.
5.  Establish incident response.
6.  Centralize monitoring and detection.
7.  Automate evidence/compliance where useful.
8.  Test control effectiveness.
